...
} from "./chunk-SXDCBUNV.js";
import {
  dataTables_default
} from "./chunk-CWP2GQLW.js";
import {
  require_jquery
} from "./chunk-NLJHGXU4.js";
import {
  __toESM
...
$.extend(Scroller.prototype, {
  ...
  construct: function() {
    ...
    that.s.stateSaveThrottle = dataTables_default.util.throttle(function() {
  ...
  _calcRowHeight: function() {
    ...
    var classes = dataTables_default.versionCheck("2") ? {
    ...
    var container = $(
      '<div class="' + classes.container + ' DTS"><div class="' + classes.scroller + '"><div class="' + classes.body + '"></div></div></div>'
    );
  ...
  _draw: function() {
    ...
    iScrollTop = this.s.scrollType === "jump" ? this._domain(
      "virtualToPhysical",
  ...
  _info: function() {
    ...
    var dt = this.s.dt, dtApi = this.s.dtApi, language = dt.oLanguage, info = dtApi.page.info(), total = info.recordsDisplay, max = info.recordsTotal;
    ...
    var possibleEnd = start + Math.floor(this.s.heights.viewport / this.s.heights.row), end = possibleEnd > total ? total : possibleEnd, result;
    if (total === 0 && total == max) {
      result = language.sInfoEmpty + language.sInfoPostFix;
    } else if (total === 0) {
      result = language.sInfoEmpty + " " + language.sInfoFiltered + language.sInfoPostFix;
    } else if (total == max) {
  ...
  _macros: function(str, start, end, max, total) {
    ...
    return str.replace(/_START_/g, formatter.call(settings, start)).replace(/_END_/g, formatter.call(settings, end)).replace(/_MAX_/g, formatter.call(settings, max)).replace(/_TOTAL_/g, formatter.call(settings, total)).replace(/_ENTRIES_/g, api.i18n("entries", "")).replace(/_ENTRIES-MAX_/g, api.i18n("entries", "", max)).replace(/_ENTRIES-TOTAL_/g, api.i18n("entries", "", total));
  },
  /**
  ...
  _scroll: function() {
    ...
    if (this.s.labelVisible) {
      ...
      ).css("top", iScrollTop + iScrollTop * labelFactor).css("display", "block");
    }
  },
  /**
...
$(document).on("preInit.dt.dtscroller", function(e, settings) {
  ...
  var defaults = dataTables_default.defaults.scroller;
  if (init || defaults) {
